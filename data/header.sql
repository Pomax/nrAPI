...
CREATE TABLE dictionary_eng          (`id` int(12) NOT NULL, `sense` int(12) NOT NULL, `data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci, KEY `id` (`id`), FULLTEXT(`data`)) DEFAULT CHARSET=utf8mb4;
...
# english should match case insensitive
CREATE TABLE kanji_dictionary_eng       (`id` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL, `data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci, KEY `id` (`id`), FULLTEXT(`data`)) DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE name_dictionary_eng  (`id` int(12) NOT NULL, `data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci, KEY `id` (`id`), FULLTEXT(`data`)) DEFAULT CHARSET=utf8mb4;
